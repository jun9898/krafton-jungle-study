    ...
    while True:
        while fireQueue:
            ...
            for i in range(4):
                ...
                if 0 <= new_y < h and 0 <= new_x < w and graph[new_y][new_x] != "*" and graph[new_y][new_x] != "#":
                    graph[new_y][new_x] = "*"
        ...
        while curQueue:
            ...
            for i in range(4):
                ...
                if new_cur_y >= h or new_cur_y < 0 or new_cur_x >= w or new_cur_x < 0:
                    return count
                if 0 <= new_cur_y < h and 0 <= new_cur_x < w and (new_cur_y, new_cur_x) not in visited and graph[new_cur_y][new_cur_x] != "#" and graph[new_cur_y][new_cur_x] != "*":
